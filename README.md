...
**Investigación de campo** Para la ideación del proyecto, se ha realizado una "lluvia de ideas" que combinase la información y la música de una forma original. En cuanto a la música y su autoría, se ha investigado en los perfiles y las páginas oficiales de las bandas para encontrar sus composiciones propias.
